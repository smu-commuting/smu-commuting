                ...
                <div className="function-info">
                    ...
                    <p className="taxi-info">
                        ...
                        <p>
                            ...
                            택시 합승이 완료됩니다.
                            <br />
                            본인이 입장한 채팅방은 목록에서 빨간 테두리로
                            표시되고, 만약 미리 생성된 채팅방이 없다면 본인이
                            원하는 시간대와 합승 인원을 선택하여 채팅방을
                            생성하면 됩니다.
                            <br />
                            택시합승구하기 페이지에서 상단의 택시 아이콘을
                            누르거나, ‘옵션변경!’이라고 써있는 수뭉이의 말풍선을
                            누르면 택시 합승 옵션을 변경할 수 있습니다.
                            <br />
                            <br />
                            <h4>⚠ 주의</h4>
                        ...
                        <p>
                            ...
                            <br />
                            자신이 속한 채팅방 리스트는 메인 화면 왼쪽 상단
                            아이콘을 통해 확인 가능합니다.
                            <br />
                            채팅방에서 상단의 역 이름을 누르면 최대 인원수를
                            변경할 수 있습니다.
                            <br />
                        ...
                        <p>
                            ...
                            가능합니다.
                            <br />
                            자신이 승차 거부한 학우의 리스트는 내 정보의 택시
                            합승 거부 설정을 통해 확인 가능하며 승차 거부를
                            해제할 수도 있습니다.
                        </p>
                    </p>
                    <br />
