...
// 오픈데이터 요청
export const BUS_INFO_MODAL_FETCH_REQUEST = 'BUS_INFO_MODAL_FETCH_REQUEST';
export const BUS_INFO_MODAL_FETCH_SUCCESS = 'BUS_INFO_MODAL_FETCH_SUCCESS';
export const BUS_INFO_MODAL_FETCH_FAILURE = 'BUS_INFO_MODAL_FETCH_FAILURE';
