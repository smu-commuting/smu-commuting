...
export const TAXI_TO_CHAT_INFO_MODAL_CLOSE_REQUEST =
    'TAXI_TO_CHAT_INFO_MODAL_CLOSE_REQUEST';
export const TAXI_TO_CHAT_INFO_MODAL_CLOSE_SUCCESS =
    'TAXI_TO_CHAT_INFO_MODAL_CLOSE_SUCCESS';
export const TAXI_TO_CHAT_INFO_MODAL_CLOSE_FAILURE =
...
// 채팅방 헤더 정보 요청
export const CHAT_ROOM_HEADER_INFO_REQUEST = 'CHAT_ROOM_HEADER_INFO_REQUEST';
export const CHAT_ROOM_HEADER_INFO_SUCCESS = 'CHAT_ROOM_HEADER_INFO_SUCCESS';
export const CHAT_ROOM_HEADER_INFO_FAILURE = 'CHAT_ROOM_HEADER_INFO_FAILURE';

// 합승 거부 목록 조회
export const USER_GET_BLOCKED_LIST_REQUEST = 'USER_GET_BLOCKED_LIST_REQUEST';
export const USER_GET_BLOCKED_LIST_SUCCESS = 'USER_GET_BLOCKED_LIST_SUCCESS';
export const USER_GET_BLOCKED_LIST_FAILURE = 'USER_GET_BLOCKED_LIST_FAILURE';

// 오픈채팅방 기존 메세지 조회
export const CHAT_BUS_ROOM_MESSAGE_REQUEST = 'CHAT_BUS_ROOM_MESSAGE_REQUEST';
export const CHAT_BUS_ROOM_MESSAGE_SUCCESS = 'CHAT_BUS_ROOM_MESSAGE_SUCCESS';
export const CHAT_BUS_ROOM_MESSAGE_FAILURE = 'CHAT_BUS_ROOM_MESSAGE_FAILURE';

// 오픈채팅방 채팅방 나갈때 state 삭제
export const CHAT_BUS_ROOM_DELETE_MESSAGE_REQUEST =
    'CHAT_BUS_ROOM_DELETE_MESSAGE_REQUEST';
export const CHAT_BUS_ROOM_DELETE_MESSAGE_SUCCESS =
    'CHAT_BUS_ROOM_DELETE_MESSAGE_SUCCESS';
export const CHAT_BUS_ROOM_DELETE_MESSAGE_FAILURE =
