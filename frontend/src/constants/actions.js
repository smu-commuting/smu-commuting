...
// 채팅방 나가기
export const CHAT_ROOM_DELETE_REQUEST = 'CHAT_ROOM_DELETE_REQUEST';
export const CHAT_ROOM_DELETE_SUCCESS = 'CHAT_ROOM_DELETE_SUCCESS';
export const CHAT_ROOM_DELETE_FAILURE = 'CHAT_ROOM_DELETE_FAILURE';
